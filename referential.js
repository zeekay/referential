...
var isBuffer$$1 = require('is-buffer');
...
var typeOf = require$$0;

var index = function isNumber(num) {
  var type = typeOf(num);
...
var index$2 = function isObject(x) {
...
var index$3 = objectAssign = (function() {
  if (shouldUseNative()) {
...
var Ref$1 = Ref = (function() {
  ...
  Ref.prototype.set = function(key, value) {
    this._mutate(key);
    if (value == null) {
      this.value(index$3(this.value(), key));
    } else {
  ...
  Ref.prototype.extend = function(key, value) {
    ...
    if (value == null) {
      ...
      if (index$2(value)) {
        this.value(index$3((this.ref(key)).get(), value));
      } else {
        clone = this.clone();
        this.set(key, value);
        this.value(index$3(clone.get(), this.value()));
      }
    }
    return this;
  };
  ...
  Ref.prototype.clone = function(key) {
    return new Ref(index$3({}, this.get(key)));
  };
